    ...
    <div className="modelcard">
      <div className="modelcard__left">
        <div className="modelcard__left--chart">
          <CircularProgressbar
            className="modelcard__left--chart-big"
            value={percent}
            text={`${percent}%`}
            strokeWidth={5}
            styles={{
              path: { stroke: `${percentBigColor}` },
              trail: { stroke: "#EAEAEC" },
              text: {
                stroke: "#535261",
                fontFamily: "Nunito",
          ...
          />
          <CircularProgressbar
            className="modelcard__left--chart-smallest"
            value={100 - percent - percent1}
            strokeWidth={5}
            styles={buildStyles({
              pathColor: `${percentSmallestColor}`,
              trailColor: "#EAEAEC",
            })}
          />
        </div>
        <div className="modelcard__left--content">
          ...
          <div className="modelcard__left--content-title">
            <div className="modelcard__left--content-title-icon">
              <img
                src={require(`../../assets/images/homepage/logo${icon}.png`)}
            ...
            <div
              className="modelcard__left--content-title-name"
              style={mainColor}
            >
              <span>{title}</span>
            </div>
